...
public:
  ...
  static void ClearCacheOnSetting(ClientContext &context, SetScope scope,
                                  Value &parameter);
};

class UCCatalog : public Catalog {
public:
  explicit UCCatalog(AttachedDatabase &db_p, const string &internal_name,
...
public:
  ...
  string GetCatalogType() override { return "uc"; }
